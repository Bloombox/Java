...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 82: {
            io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures.Builder subBuilder = null;
            if (features_ != null) {
              subBuilder = features_.toBuilder();
            }
            features_ = input.readMessage(io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  private io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures features_;
  /**
   * <pre>
   ...
   * <code>.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures features = 10;</code>
   */
  public io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures getFeatures() {
    return features_ == null ? io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures.getDefaultInstance() : features_;
  }
  /**
   * <pre>
   * Flags indicating features that should be enabled or disabled.
   ...
   * <code>.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures features = 10;</code>
   */
  public io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeaturesOrBuilder getFeaturesOrBuilder() {
    return getFeatures();
  }
  ...
  checkByteStringIsUtf8(value);
    ...
    private io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures features_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
        io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures, io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures.Builder, io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeaturesOrBuilder> featuresBuilder_;
    /**
     * <pre>
     * Flags indicating features that should be enabled or disabled.
     * </pre>
     ...
     * <code>.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures features = 10;</code>
     */
    public Builder setFeatures(io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures value) {
      if (featuresBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setFeatures(
        io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures.Builder builderForValue) {
      if (featuresBuilder_ == null) {
     ...
     * <code>.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures features = 10;</code>
     */
    public Builder mergeFeatures(io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures value) {
      if (featuresBuilder_ == null) {
        if (features_ != null) {
          features_ =
            io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures.newBuilder(features_).mergeFrom(value).buildPartial();
        } else {
          features_ = value;
        }
        onChanged();
     ...
     * <code>.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures features = 10;</code>
     */
    public io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures.Builder getFeaturesBuilder() {
    ...
    public io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeaturesOrBuilder getFeaturesOrBuilder() {
      if (featuresBuilder_ != null) {
        ...
        return features_ == null ?
            io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures.getDefaultInstance() : features_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures, io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeatures.Builder, io.bloombox.schema.partner.integrations.greenbits.GreenbitsIntegrationFeaturesOrBuilder> 
