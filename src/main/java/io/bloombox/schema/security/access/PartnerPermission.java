...
/**
 * Protobuf enum {@code bloombox.schema.security.access.PartnerPermission}
 */
public enum PartnerPermission
  ...
  // @@protoc_insertion_point(enum_scope:bloombox.schema.security.access.PartnerPermission)
}
