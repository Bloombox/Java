...
public interface HashOrBuilder extends
    // @@protoc_insertion_point(interface_extends:crypto.primitives.integrity.Hash)
   ...
   * <code>.crypto.primitives.integrity.HashAlgorithm algorithm = 1;</code>
   */
  io.bloombox.schema.crypto.primitives.integrity.HashAlgorithm getAlgorithm();
  ...
  public io.bloombox.schema.crypto.primitives.integrity.Hash.DigestCase getDigestCase();
}
