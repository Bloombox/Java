...
public final class MenuServiceBeta1 {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "section}:retrieve\222A6\022\010Retrieve\032 Fetch pr" +
      "oduct catalog/menu data.*\010Retrieve\022\374\002\n\010F" +
      "eatured\022:.bloombox.schema.services.menu." +
      "v1beta1.GetFeatured.Request\032;.bloombox.s" +
      "chema.services.menu.v1beta1.GetFeatured." +
      "Response\"\366\001\202\323\344\223\002\223\001\022E/menu/v1beta1/{scope" +
      "=partners/*/locations/*}/global/featured" +
      ":retrieveZJ\022H/menu/v1beta1/{scope=partne" +
      "rs/*/locations/*}/{section}/featured:ret" +
      "rieve\222AY\022\010Featured\032CRetrieve products ma" +
      "rked for extra attention (\'featured\' pro" +
      "ducts).*\010Featured\022\246\002\n\010Products\0229.bloombo" +
      "x.schema.services.menu.v1beta1.GetProduc" +
      "t.Request\032:.bloombox.schema.services.men" +
      "u.v1beta1.GetProduct.Response\"\242\001\202\323\344\223\002D\022B" +
      "/menu/v1beta1/{scope=partners/*/location" +
      "s/*}/products/{key}/detail\222AU\022\010Products\032" +
      "?Retrieve payload data for one or more p" +
      "roducts, by product key.*\010Products\022\355\002\n\006S" +
      "earch\0229.bloombox.schema.services.menu.v1" +
      "beta1.SearchMenu.Request\032:.bloombox.sche" +
      "ma.services.menu.v1beta1.SearchMenu.Resp" +
      "onse\"\353\001\202\323\344\223\002\233\001\022P/menu/v1beta1/{search.op" +
      "tions.scope=partners/*/locations/*}/sear" +
      "ch/{search.term}ZG\"B/menu/v1beta1/{searc" +
      "h.options.scope=partners/*/locations/*}/" +
      "search:\001*\222AF\022\006Search\0324Perform a fulltext" +
      " search over product catalog data.*\006Sear" +
