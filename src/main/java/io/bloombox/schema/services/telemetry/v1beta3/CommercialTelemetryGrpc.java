...
public final class CommercialTelemetryGrpc {
  ...
  public static final io.grpc.MethodDescriptor<io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Impression,
      ...
      io.grpc.MethodDescriptor.<io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Impression, com.google.protobuf.Empty>newBuilder()
          ...
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.View,
      ...
      io.grpc.MethodDescriptor.<io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.View, com.google.protobuf.Empty>newBuilder()
          ...
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Action,
  ...
  public static abstract class CommercialTelemetryImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void impression(io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Impression request,
     ...
     * </pre>
     */
    public void view(io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.View request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
     ...
     * </pre>
     */
    public void action(io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Action request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Impression,
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.View,
                com.google.protobuf.Empty>(
                  this, METHODID_VIEW)))
          .addMethod(
            METHOD_ACTION,
            asyncUnaryCall(
              new MethodHandlers<
                io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Action,
                com.google.protobuf.Empty>(
  ...
  public static final class CommercialTelemetryBlockingStub extends io.grpc.stub.AbstractStub<CommercialTelemetryBlockingStub> {
     ...
     * </pre>
     */
    public com.google.protobuf.Empty impression(io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Impression request) {
     ...
     * </pre>
     */
    public com.google.protobuf.Empty view(io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.View request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public com.google.protobuf.Empty action(io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Action request) {
      return blockingUnaryCall(
  ...
  public static final class CommercialTelemetryFutureStub extends io.grpc.stub.AbstractStub<CommercialTelemetryFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> impression(
        io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Impression request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> view(
        io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.View request) {
      return futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> action(
        io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Action request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_IMPRESSION:
          serviceImpl.impression((io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Impression) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_VIEW:
          serviceImpl.view((io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.View) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_ACTION:
          serviceImpl.action((io.bloombox.schema.services.telemetry.v1beta3.CommercialEvent.Action) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
