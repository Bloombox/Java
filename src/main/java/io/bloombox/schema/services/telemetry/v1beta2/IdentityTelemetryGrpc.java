...
public final class IdentityTelemetryGrpc {
  ...
  public static final String SERVICE_NAME = "services.telemetry.v1beta2.IdentityTelemetry";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.bloombox.schema.services.telemetry.v1beta2.IdentityEvent.Action,
      com.google.protobuf.Empty> METHOD_ACTION =
      io.grpc.MethodDescriptor.<io.bloombox.schema.services.telemetry.v1beta2.IdentityEvent.Action, com.google.protobuf.Empty>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "services.telemetry.v1beta2.IdentityTelemetry", "Action"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              io.bloombox.schema.services.telemetry.v1beta2.IdentityEvent.Action.getDefaultInstance()))
  ...
  public static abstract class IdentityTelemetryImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void action(io.bloombox.schema.services.telemetry.v1beta2.IdentityEvent.Action request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.bloombox.schema.services.telemetry.v1beta2.IdentityEvent.Action,
  ...
  public static final class IdentityTelemetryBlockingStub extends io.grpc.stub.AbstractStub<IdentityTelemetryBlockingStub> {
     ...
     * </pre>
     */
    public com.google.protobuf.Empty action(io.bloombox.schema.services.telemetry.v1beta2.IdentityEvent.Action request) {
  ...
  public static final class IdentityTelemetryFutureStub extends io.grpc.stub.AbstractStub<IdentityTelemetryFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> action(
        io.bloombox.schema.services.telemetry.v1beta2.IdentityEvent.Action request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ACTION:
          serviceImpl.action((io.bloombox.schema.services.telemetry.v1beta2.IdentityEvent.Action) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
