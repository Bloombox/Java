...
public interface StaticMenuOrBuilder extends
  ...
  java.util.Map<java.lang.String, io.opencannabis.schema.product.ApothecaryProduct.Apothecary>
  getApothecary();
  /**
   * <pre>
   * Specifies APOTHECARY products attached to this menu.
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, io.opencannabis.schema.product.CartridgeProduct.Cartridge>
  getCartridges();
  /**
   * <pre>
   * Specifies CARTRIDGE products attached to this menu.
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, io.opencannabis.schema.product.EdibleProduct.Edible>
  getEdibles();
  /**
   * <pre>
   * Specifies EDIBLE products attached to this menu.
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, io.opencannabis.schema.product.ExtractProduct.Extract>
  getExtracts();
  /**
   * <pre>
   * Specifies EXTRACT products attached to this menu.
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, io.opencannabis.schema.product.FlowerProduct.Flower>
  getFlowers();
  /**
   * <pre>
   * Specifies FLOWER products attached to this menu.
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, io.opencannabis.schema.product.MerchandiseProduct.Merchandise>
  getMerchandise();
  /**
   * <pre>
   * Specifies MERCHANDISE products attached to this menu.
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, io.opencannabis.schema.product.PlantProduct.Plant>
  getPlants();
  /**
   * <pre>
   * Specifies PLANT products attached to this menu.
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, io.opencannabis.schema.product.PrerollProduct.Preroll>
  getPrerolls();
  /**
   * <pre>
   * Specifies PREROLL products attached to this menu.
