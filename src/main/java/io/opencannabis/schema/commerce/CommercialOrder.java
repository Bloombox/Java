...
public final class CommercialOrder {
   ...
   * </pre>
   *
   * Protobuf enum {@code opencannabis.commerce.OrderPaymentStatus}
   */
  public enum OrderPaymentStatus
     ...
     * <code>BOUNCED = 5;</code>
     */
    public static final int BOUNCED_VALUE = 5;
    /**
     * <pre>
     * Payment for this order did not go through, and was retried.
     * </pre>
     ...
     * <code>RETRIED = 6;</code>
     */
    public static final int RETRIED_VALUE = 6;
     ...
     */
    @java.lang.Deprecated
    public static OrderPaymentStatus valueOf(int value) {
      return forNumber(value);
    }

    public static OrderPaymentStatus forNumber(int value) {
      switch (value) {
        ...
        case 5: return BOUNCED;
        case 6: return RETRIED;
        default: return null;
      }
    }

    public static com.google.protobuf.Internal.EnumLiteMap<OrderPaymentStatus>
        internalGetValueMap() {
      return internalValueMap;
    }
    private static final com.google.protobuf.Internal.EnumLiteMap<
        OrderPaymentStatus> internalValueMap =
          new com.google.protobuf.Internal.EnumLiteMap<OrderPaymentStatus>() {
            public OrderPaymentStatus findValueByNumber(int number) {
              return OrderPaymentStatus.forNumber(number);
            }
          };
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return io.opencannabis.schema.commerce.CommercialOrder.getDescriptor().getEnumTypes().get(3);
    }

    private static final OrderPaymentStatus[] VALUES = values();

    public static OrderPaymentStatus valueOf(
        com.google.protobuf.Descriptors.EnumValueDescriptor desc) {
      if (desc.getType() != getDescriptor()) {
        throw new java.lang.IllegalArgumentException(
          "EnumValueDescriptor is not for this type.");
    ...
    // @@protoc_insertion_point(enum_scope:opencannabis.commerce.OrderPaymentStatus)
  }
  ...
  public interface OrderPaymentOrBuilder extends
     ...
     * </pre>
     *
     * <code>.opencannabis.commerce.OrderPaymentStatus status = 1 [(.gen_bq_schema.description) = "Status of payment for this order."];</code>
     */
    int getStatusValue();
    /**
     * <pre>
     ...
     * <code>.opencannabis.commerce.OrderPaymentStatus status = 1 [(.gen_bq_schema.description) = "Status of payment for this order."];</code>
     */
    io.opencannabis.schema.commerce.CommercialOrder.OrderPaymentStatus getStatus();
     ...
     * </pre>
     *
     * <code>.opencannabis.commerce.PaymentMethod method = 2 [(.gen_bq_schema.description) = "Method of payment used on this order."];</code>
     */
    int getMethodValue();
    /**
     * <pre>
     ...
     * </pre>
     *
     * <code>double tax = 3 [(.gen_bq_schema.description) = "Amount of tax added to the subtotal."];</code>
     */
    double getTax();
     ...
     * </pre>
     *
     * <code>double paid = 4 [(.gen_bq_schema.description) = "Amount the user has paid so far for this order."];</code>
     */
    double getPaid();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
     ...
     * <code>.opencannabis.commerce.OrderPaymentStatus status = 1 [(.gen_bq_schema.description) = "Status of payment for this order."];</code>
     */
    public io.opencannabis.schema.commerce.CommercialOrder.OrderPaymentStatus getStatus() {
      io.opencannabis.schema.commerce.CommercialOrder.OrderPaymentStatus result = io.opencannabis.schema.commerce.CommercialOrder.OrderPaymentStatus.valueOf(status_);
      return result == null ? io.opencannabis.schema.commerce.CommercialOrder.OrderPaymentStatus.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (status_ != io.opencannabis.schema.commerce.CommercialOrder.OrderPaymentStatus.NOT_APPLICABLE.getNumber()) {
    ...
    public static final class Builder extends
       ...
       * <code>.opencannabis.commerce.OrderPaymentStatus status = 1 [(.gen_bq_schema.description) = "Status of payment for this order."];</code>
       */
      public Builder setStatus(io.opencannabis.schema.commerce.CommercialOrder.OrderPaymentStatus value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final com.google.protobuf.Parser<OrderPayment>
        PARSER = new com.google.protobuf.AbstractParser<OrderPayment>() {
    ...
    public static com.google.protobuf.Parser<OrderPayment> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<OrderPayment> getParserForType() {
      return PARSER;
    }
  ...
  public interface StatusCheckinOrBuilder extends
     ...
     * </pre>
     *
     * <code>.opencannabis.commerce.OrderStatus status = 1;</code>
     */
    int getStatusValue();
    /**
     * <pre>
  ...
  public interface OrderOrBuilder extends
     ...
     * </pre>
     *
     * <code>.opencannabis.commerce.OrderPayment payment = 14 [(.gen_bq_schema.description) = "Payment information/metadata for this order, if applicable."];</code>
     */
    boolean hasPayment();
    /**
     * <pre>
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "to\032\026commerce/Payment.proto\032\027commerce/Del" +
      "ivery.proto\032\027commerce/Customer.proto\032\026te" +
      "mporal/Instant.proto\"\343\001\n\017OrderScheduling" +
      "\022q\n\nscheduling\030\001 \001(\0162%.opencannabis.comm" +
      "erce.SchedulingTypeB6\360?\001\212@0Scheduling ty" +
      "pe, either \'ASAP\' or a target time.\022]\n\014d" +
      "esired_time\030\002 \001(\0132\036.opencannabis.tempora" +
      "l.InstantB\'\212@$Desired delivery time, if " +
      "specified.\"\307\002\n\014OrderPayment\022_\n\006status\030\001 " +
      "\001(\0162).opencannabis.commerce.OrderPayment" +
      "StatusB$\212@!Status of payment for this or" +
      "der.\022^\n\006method\030\002 \001(\0162$.opencannabis.comm" +
      "erce.PaymentMethodB(\212@%Method of payment" +
      " used on this order.\0224\n\003tax\030\003 \001(\001B\'\212@$Am" +
      "ount of tax added to the subtotal.\022@\n\004pa" +
      "id\030\004 \001(\001B2\212@/Amount the user has paid so" +
      " far for this order.\"\205\001\n\rStatusCheckin\0222" +
      "\n\006status\030\001 \001(\0162\".opencannabis.commerce.O" +
      "rderStatus\022/\n\007instant\030\002 \001(\0132\036.opencannab" +
      "is.temporal.Instant\022\017\n\007message\030\003 \001(\t\"J\n\010" +
      "OrderKey\022>\n\002id\030\001 \001(\tB2\212@/Order ID, assig" +
      "ned by the server upon creation.\"\267\010\n\005Ord" +
      "er\022b\n\002id\030\001 \001(\tBV\360?\001\212@PID assigned to the" +
      " order by the server, and potentially no" +
      "minated by the client.\022j\n\004type\030\002 \001(\0162 .o" +
      "pencannabis.commerce.OrderTypeB:\360?\001\212@4Ty" +
      "pe of order requested - either PICKUP or" +
      " DELIVERY.\0227\n\006status\030\003 \001(\0162\".opencannabi" +
      "s.commerce.OrderStatusB\003\200@\001\022\\\n\010customer\030" +
      "\004 \001(\0132\037.opencannabis.commerce.CustomerB)" +
      "\360?\001\212@#Customer that submitted this order" +
      ".\022a\n\nscheduling\030\005 \001(\0132&.opencannabis.com" +
      "merce.OrderSchedulingB%\360?\001\212@\037Scheduling " +
      "spec for this order.\022i\n\013destination\030\006 \001(" +
      "\0132*.opencannabis.commerce.DeliveryDestin" +
      "ationB(\212@%Location for delivery, if appl" +
      "icable.\022\022\n\005notes\030\007 \001(\tB\003\200@\001\022.\n\004item\030\010 \003(" +
      "\0132\033.opencannabis.commerce.ItemB\003\200@\001\022=\n\na" +
      "ction_log\030\t \003(\0132$.opencannabis.commerce." +
      "StatusCheckinB\003\200@\001\022V\n\ncreated_at\030\n \001(\0132\036" +
      ".opencannabis.temporal.InstantB\"\360?\001\212@\034Wh" +
      "en this order was created.\022$\n\010subtotal\030\013" +
      " \001(\001B\022\212@\017Order subtotal.\0227\n\nupdated_at\030\014" +
      " \001(\0132\036.opencannabis.temporal.InstantB\003\200@" +
      "\001\022I\n\003sid\030\r \001(\tB<\212@9Session ID that was a" +
      "ctive when this order was submitted.\022t\n\007" +
      "payment\030\016 \001(\0132#.opencannabis.commerce.Or" +
      "derPaymentB>\212@;Payment information/metad" +
      "ata for this order, if applicable.*=\n\tOr" +
      ...
      "GNED\020\003\022\014\n\010EN_ROUTE\020\004\022\r\n\tFULFILLED\020\005*|\n\022O" +
      "rderPaymentStatus\022\022\n\016NOT_APPLICABLE\020\000\022\013\n" +
      "\007WAITING\020\001\022\021\n\rPREAUTHORIZED\020\002\022\013\n\007PARTIAL" +
      "\020\003\022\013\n\007SETTLED\020\004\022\013\n\007BOUNCED\020\005\022\013\n\007RETRIED\020" +
      "\006B<\n\037io.opencannabis.schema.commerceB\017Co" +
      "mmercialOrderH\001P\000\242\002\003OCSb\006proto3"
    };
