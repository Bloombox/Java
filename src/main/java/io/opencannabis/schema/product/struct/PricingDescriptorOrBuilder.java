...
public interface PricingDescriptorOrBuilder extends
   ...
   * <code>.opencannabis.structs.pricing.FreebiePricingDescriptor freebie = 22;</code>
   */
  io.opencannabis.schema.product.struct.FreebiePricingDescriptor getFreebie();
  /**
   * <code>.opencannabis.structs.pricing.FreebiePricingDescriptor freebie = 22;</code>
   */
  io.opencannabis.schema.product.struct.FreebiePricingDescriptorOrBuilder getFreebieOrBuilder();

  public io.opencannabis.schema.product.struct.PricingDescriptor.PricingCase getPricingCase();
}
